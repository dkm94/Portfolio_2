    ...
    return (
        <div onMouseEnter={showTitle} onMouseLeave={showTitle} style={full}>
            <div className="intro" style={{ position: "relative"}}>
                <h2 style={{ textAlign: "end"}}>Qui suis-je ?</h2>   
                ...
                Je suis ouverte aux projets frontend, backend et fullstack. En tant que junior, je suis prête à mettre en application toutes mes connaissances acquises depuis le début de mon parcours dans le développement et à donner mon maximum afin d'apporter une vraie plus value à votre équipe ! 
                </p>
